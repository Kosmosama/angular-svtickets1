...
export const routes: Routes = [
    ...
    // { path: "edit/:id", data: { animation: 'eventEdit' }, canActivate: [numericIdGuard], canDeactivate: [leavePageGuard], loadComponent: () => import("./event-detail/event-detail.component").then((c) => c.EventDetailComponent), resolve: { event: eventResolver }, title: "Edit event | SVtickets"},
];
